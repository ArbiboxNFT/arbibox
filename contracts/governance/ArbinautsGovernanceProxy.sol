...
/// @title The Arbinauts Governance proxy contract



// LICENSE
// ArbinautsGovernanceProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// ArbinautsGovernanceProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract ArbinautsGovernanceProxy is ArbinautsGovernanceProxyStorage, ArbinautsGovernanceEvents {
    constructor(
        address timelock_,
        address arbinauts_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'ArbinautsGovernanceProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'ArbinautsGovernanceProxy::_setImplementation: invalid implementation address');
