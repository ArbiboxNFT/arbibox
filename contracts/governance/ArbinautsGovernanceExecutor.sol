...
contract ArbinautsGovernanceExecutor {
    ...
    function acceptAdmin() public {
        require(msg.sender == pendingAdmin, 'ArbinautsGovernanceExecutor::acceptAdmin: Call must come from pendingAdmin.');
        admin = msg.sender;
    ...
    function setPendingAdmin(address pendingAdmin_) public {
        require(
            ...
            'ArbinautsGovernanceExecutor::setPendingAdmin: Call must come from ArbinautsGovernanceExecutor.'
        );
    ...
    function queueTransaction(
        ...
        require(msg.sender == admin, 'ArbinautsGovernanceExecutor::queueTransaction: Call must come from admin.');
        require(
            eta >= getBlockTimestamp() + delay,
            'ArbinautsGovernanceExecutor::queueTransaction: Estimated execution block must satisfy delay.'
        );
    ...
    function cancelTransaction(
        ...
        require(msg.sender == admin, 'ArbinautsGovernanceExecutor::cancelTransaction: Call must come from admin.');
    ...
    function executeTransaction(
        ...
        require(msg.sender == admin, 'ArbinautsGovernanceExecutor::executeTransaction: Call must come from admin.');

        bytes32 txHash = keccak256(abi.encode(target, value, signature, data, eta));
        require(queuedTransactions[txHash], "ArbinautsGovernanceExecutor::executeTransaction: Transaction hasn't been queued.");
        require(
            getBlockTimestamp() >= eta,
            "ArbinautsGovernanceExecutor::executeTransaction: Transaction hasn't surpassed time lock."
        );
        require(
            getBlockTimestamp() <= eta + GRACE_PERIOD,
            'ArbinautsGovernanceExecutor::executeTransaction: Transaction is stale.'
        );
        ...
        require(success, 'ArbinautsGovernanceExecutor::executeTransaction: Transaction execution reverted.');
