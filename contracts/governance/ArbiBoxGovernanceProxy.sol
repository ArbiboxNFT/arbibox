...
/// @title The ArbiBox Governance proxy contract



// LICENSE
// ArbiBoxGovernanceProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// ArbiBoxGovernanceProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract ArbiBoxGovernanceProxy is ArbiBoxGovernanceProxyStorage, ArbiBoxGovernanceEvents {
    constructor(
        address timelock_,
        address arbibox_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'ArbiBoxGovernanceProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'ArbiBoxGovernanceProxy::_setImplementation: invalid implementation address');
