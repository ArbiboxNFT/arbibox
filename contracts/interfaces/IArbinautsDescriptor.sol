...
/// @title Interface for ArbinautsDescriptor
...
interface IArbinautsDescriptor {
    event PartsLocked();
    ...
    function tokenURI(uint256 tokenId, IArbinautsSeeder.Seed memory seed) external view returns (string memory);

    function dataURI(uint256 tokenId, IArbinautsSeeder.Seed memory seed) external view returns (string memory);
    ...
    function generateSVGImage(IArbinautsSeeder.Seed memory seed) external view returns (string memory);
}