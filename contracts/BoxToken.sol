...
contract BoxToken is AccessControl, ERC20 {
    ...
    string constant _name = "ArbiBox Box Token";
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        if (_isContract(msg.sender)) {
            require(allowedContracts[msg.sender], "This contract is not approved to interact with BOX");
        }
    ...
    function setTransferRestricted(bool _restricted) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "BOX: NOT_ALLOWED");
    ...
    function burnFrom(address _from, uint256 _amount) public {	
        require(hasRole(BURNER_ROLE, msg.sender), "BOX: NOT_ALLOWED");	
    ...
    function mint(address _to, uint256 _amount) public {
        require(hasRole(MINTER_ROLE, msg.sender), "BOX: NOT_ALLOWED");
        _mint(_to, _amount);
